...
LRCLIB_USER_AGENT = "Sal0-Karaoke/9.0.2 (+https://github.com/Sal0-Apps/Sal0-Karaoke)"
...
# Sistema de Logs de Diagnóstico v9.0.2
...
def download_diagnostic_logs(current_user: dict = Depends(get_current_user)):
    ...
    report = "\n".join([
"Sal0 Karaokê v9.0.2 — diagnóstico ao vivo",
