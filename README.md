...
* `2.2.3`: Versão estável com biblioteca permanente de mídias, suporte a vídeos de fundo em loop, download direto do YouTube, criptografia forte PBKDF2 e preview sobreposto ao fundo real.
...
`image: ghcr.io/sal0-apps/sal0-karaoke:2.2.3`

---

## 🔐 Controle de Acesso e Contas Locais

A partir da versão **2.2.3**, o Sal0 Karaokê conta com armazenamento criptográfico forte das senhas de usuários:
