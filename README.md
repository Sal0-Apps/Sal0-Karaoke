...
* `3.0.5`: Versão estável com biblioteca permanente de mídias, suporte a vídeos de fundo em loop, download direto do YouTube, criptografia forte PBKDF2 e preview sobreposto ao fundo real.
...
A partir da versão **3.0.5**, o Sal0 Karaokê conta com armazenamento criptográfico forte das senhas de usuários:
